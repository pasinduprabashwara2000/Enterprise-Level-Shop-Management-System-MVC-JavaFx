...
public class SupplierModel {
    ...
    public String saveSupplier(SupplierDTO supplierDTO) throws Exception {
        ...
        String sql = "INSERT INTO Supplier (supplierID, name, contactPerson, phone, email, address) VALUES(?,?,?,?,?,?)";
        PreparedStatement pstm = connection.prepareStatement(sql);
        pstm.setString(1, supplierDTO.getSupplierID());
        pstm.setString(2, supplierDTO.getName());
        pstm.setString(3, supplierDTO.getContactPerson());
        pstm.setInt(4, supplierDTO.getPhone());
